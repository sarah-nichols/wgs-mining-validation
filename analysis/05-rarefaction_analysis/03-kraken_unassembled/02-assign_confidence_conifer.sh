...
for file in "$KRAKEN_RESULTS"/output/*.report; do
  ...
  # Extract the sample ID from the filename by removing the 'paired_' prefix and preserving the rest up to the first dot
